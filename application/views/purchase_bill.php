                ...
                <form id="payment" class="form-horizontal">
					...
					<div class="col-md-6" style="float:left;">
						...
						<div class="form-group row">
							...
							<div class="col-sm-4">
							   <!-- <input type="date" style="text-align:right" class="form-control" id="entry_date"> -->
							   <div class="input-group date doj" data-provide="datepicker">
					...
					<div class="col-md-6" style="float:right;">
                        <div class="form-group row">
                            ...
                            <div class="col-sm-9">
							<select id="supplier" name="supplier" style="width:200px;" class="form-control suppliernm">
							...
							<table id="purchase_bill" class="table table-striped" width="100%" cellspacing="0" >
								<thead>
									...
									<tr>
										...
										<td>
											<select  id="item_name" style="width:100px;" name="item_name" class="form-control">
											</select>
										</td>
										<td>
											<input type="text" style="width:70px;" value="0" class="form-control" id="mrp" placeholder="MRP">
										</td>
										<td>
											<input type="number" style="width:70px;" value="0" class="form-control" id="qty" placeholder="Quantity">
										</td>
										<td>
											<input type="number" style="width:70px;" value="0" class="form-control" id="discount" placeholder="Discount">
										</td>
										<td>
											<input type="number" style="width:70px;"  value="0" class="form-control" id="gst" placeholder="GST">
										</td>
										<td>
											<input type="text" disabled style="width:70px;" value="0" class="form-control" id="total" placeholder="Total">
										</td>
										<td>
...
var tit="Purchase Bill Details";
</script>
<script src="<?php echo base_url(); ?>dist/js/filldata.js"></script>
<script src="<?php echo base_url(); ?>dist/js/purchase_bill.js"></script>
