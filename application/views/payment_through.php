		...
		<div id="form" class="col-md-12">
            <div class="card">
			   ...
			   <form id="mainform" method="post" class="form-horizontal">
                    <div class="card-body">
                        <h4 class="card-title">Payment Through</h4>
					</div>
					<div class="col-md-6" style="float:left;">
                        <div class="form-group row">
                            <label for="fname" class="col-sm-3 text-right control-label col-form-label">Payment Option</label>
                            <div class="col-sm-9">
                                <input type="text" required class="form-control" id="name" placeholder="Payment Option">
                            </div>
                        </div>
...
var table_name="payment_option";
var tit="Payment Through Details";
</script>
<script src="<?php echo base_url(); ?>dist/js/item_type.js"></script>
