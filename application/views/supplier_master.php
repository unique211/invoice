		...
		<div id="form" class="col-md-12">
            <div class="card">
				<input type="hidden" name="userid" id="userid" value="<?php echo $this->session->userdata('id'); ?>"/>
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Suplier master</h4>
					</div>
					<div class="col-md-6" style="float:left;">
                        <div class="form-group row">
                            <label for="fname" class="col-sm-3 text-right control-label col-form-label">Supplier Name</label>
                            <div class="col-sm-9">
                                <input type="text" required class="form-control" id="name" placeholder="Supplier Name">
                            </div>
                        </div>
						<div class="form-group row">
						...
						<div class="form-group row">
		                    <label for="lname" class="col-sm-3 text-right control-label col-form-label">Contact Person</label>
		                    <div class="col-sm-9">
		                        <input type="text" required class="form-control" id="con_person" placeholder="Contact person">
		                    </div>
						</div>
						<div class="form-group row">
		                    <label for="lname" class="col-sm-3 text-right control-label col-form-label">Contact Number</label>
		                    <div class="col-sm-9">
		                        <input type="number" required minlength="10" maxlength="10" class="form-control" id="con_number" placeholder="Contact Number">
		                    </div>
						</div>
					</div>
...
<script src="<?php echo base_url(); ?>dist/js/supplier.js"></script>
