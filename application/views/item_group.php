				...
				<form id="mainform" method="post" class="form-horizontal">
					...
					<div class="col-md-6" style="float:left;">
                        <div class="form-group row">
                            <label for="fname" class="col-sm-3 text-right control-label col-form-label">Item Group</label>
                            <div class="col-sm-9">
                                <input type="text" required class="form-control" id="name" placeholder="Item Group">
                            </div>
                        </div>
					</div>
