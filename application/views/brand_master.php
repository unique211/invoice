				...
				<form id="mainform" method="post" class="form-horizontal">
					...
					<div class="col-md-6" style="float:left;">
                        <div class="form-group row">
                            <label for="fname" class="col-sm-3 text-right control-label col-form-label">Brand Master</label>
                            <div class="col-sm-9">
                                <input type="text" required class="form-control" id="name" placeholder="Brand Name">
                            </div>
                        </div>
					</div>
...
var table_name="item_group";
var tit="Brand Master Details";
</script>
<script src="<?php echo base_url(); ?>dist/js/brand_master.js"></script>
