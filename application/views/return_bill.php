		...
		<div id="form" class="col-md-12">
            <div class="card">
				<input type="hidden" name="userid" id="userid" value="<?php echo $this->session->userdata('id'); ?>"/>
                    ...
                    <div class="card-body">
                        <h4 class="card-title">Return Bill</h4>
					</div>
					...
					<div class="col-md-6" style="float:right;">
						<div class="form-group row">
                            <label for="invoice" class="col-sm-3 text-right control-label col-form-label">Old Invoice No.</label>
                            <div class="col-sm-4">
								<select id="invoice" name="invoice" style="width:200px;" class="form-control invoice">
                            	</select>
                            </div>
                        </div>
						...
						<div class="form-group row">
							...
							<div class="input-group date doj" data-provide="datepicker">
									<input type="text" class="form-control input-sm placeholdesize datepicker"  id="invoice_date" name="invoice_date"  >
							...
							<table id="purchase_bill" class="table table-striped" style="width:100%;table-layout: fixed;"  cellspacing="0">
								<thead>
									...
									<tr>
										...
										<td>
											<input type="text" value="0" style="width:80px;" class="form-control" id="mrp" placeholder="MRP">
										</td>
										<td>
										...
										<td>
											<input type="number" value="0" style="width:50px;" class="form-control" id="cgst" placeholder="GST">
										</td>
										<td>
											<input type="number" value="0" style="width:50px;" class="form-control" id="sgst" placeholder="GST">
										</td>
										<td>
											<input disabled type="number" value="0" style="width:70px;" class="form-control" id="total" placeholder="Total">
										</td>
										<td>
											<button class="btn btn-sm btn-xs btn-success" name="add" id="add"><i class="mdi mdi-plus"></i></button>
										</td>
									</tr>
								</thead>
					...
					<div class="col-md-6" style="float:right;">
						...
						<div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input type="number" style="text-align:right" value="0" class="form-control" id="discountless" placeholder="Discount less +/-">
                            </div>
						...
						<div class="form-group row">
                            ...
                            <div class="col-sm-3">
                                <input disabled  type="number" value="0" style="text-align:right" class="form-control" id="cgst1" placeholder="CGST %">
                            </div>
							<label for="cgst_amount" class="col-sm-3 text-right control-label col-form-label">CGST Amount</label>
							<div class="col-sm-3">
                                <input disabled  type="number" value="0" style="text-align:right" class="form-control" id="cgst_amount" placeholder="CGST Amount">
                            </div>
                        </div>
						<div class="form-group row">
							<label for="sgst%" class="col-sm-3 text-right control-label col-form-label">SGST %</label>
                            <div class="col-sm-3">
                                <input disabled  type="number" value="0" style="text-align:right" class="form-control" id="sgst1" placeholder="SGST %">
                            </div>
							<label for="sgst_amount" class="col-sm-3 text-right control-label col-form-label">SGST Amount</label>
							<div class="col-sm-3">
					...
					<div class="col-md-9" style="float:right;">
						...
						<div class="form-group row">
							...
							<div class="col-sm-2">
                                <input disabled value="0" type="number" style="text-align:right" class="form-control" id="Balance" placeholder="Balance">
                            </div>
							<label for="total_amount" class="col-sm-2 text-right control-label col-form-label">Total Amount</label>
							<div class="col-sm-2">
                                <input disabled value="0" type="number" style="text-align:right" class="form-control" id="total_amount" placeholder="Total Amount">
                            </div>
                        </div>
					</div>
...
var tit="Sales_Return Details";
</script>
<script src="<?php echo base_url(); ?>dist/js/filldata.js"></script>
<script src="<?php echo base_url(); ?>dist/js/salesreturn.js"></script>
